#ifndef UTILITY_REGISTER_H_
#define UTILITY_REGISTER_H_
...
template <typename T>
constexpr std::size_t SizeInBits() { return sizeof (T) * 8; }
...
struct StaticRegister {
  ...
  constexpr static RawType DoMakeValue(Arg arg) {
    ...
    return static_cast<RawType>((static_cast<RawType>(arg.value) & arg.mask) << GetOffset<Arg::index>());
  }
...
struct ValidateRegister {
  static_assert (sizeof (Register) == sizeof (typename Register::StaticInterface::RegisterType),
